...
def _build_briefing(ip: str, matched_pattern: str, severity: int) -> str:
    ...
    return (
        f"Aegis team, this is Specter. {threat}. "
        f"Source IP {ip_words}. "
        f"Severity {sev_word}. "
...
async def receive_alert(
    ...
    # Queue a proactive voice briefing for the listener to pick up
    briefing_text = _build_briefing(alert.ip, alert.matched_pattern, alert.severity)
